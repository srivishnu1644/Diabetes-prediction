...
root.title("An Integrated Approach for Detecting Diabetes and Recommending Diet Plans in Healthcare Big Data Clouds Using Ensemble Framework")
...
font = ('times', 14, 'bold')
title = Label(root, text='An Integrated Approach for Detecting Diabetes and Recommending Diet Plans in Healthcare Big Data Clouds')
title.config(bg='Olive', fg='Black')  
...
pathlabel.config(bg='blue', fg='Olive')  
